...
skeleton = [(0, 2), (2, 4), (1, 3), (3, 5), (1, 13), (0, 13), (12, 13), (1, 7), (0, 6), (6, 7), (7, 9), (6, 8), (9, 11), (8, 10)]

keypoint_groups_definition = [
    # ---- CrowdPose keypoints ----
    [0, 2, 4],   # Right shoulder, elbow, wrist
    [1, 3, 5],   # Left shoulder, elbow, wrist
    [6, 7],      # Hips
    [6, 8, 10],  # Right hip, knee, ankle
    [7, 9, 11],  # Left hip, knee, ankle
    [13, 6, 7],  # Neck, chest, abdomen
    [13, 12],    # Top of head, neck
]
